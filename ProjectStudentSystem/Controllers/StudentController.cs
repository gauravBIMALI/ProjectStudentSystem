...
namespace ProjectStudentSystem.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(ILogger<StudentController> logger, UserManager<Users> userManager, RoleManager<IdentityRole> roleManager, AppDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var model = new ViewModels.StudentProfileViewModel
            {
        ...
        [HttpPost]
        public async Task<IActionResult> EditProfile(ViewModels.StudentProfileViewModel model)
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
